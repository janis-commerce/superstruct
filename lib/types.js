...
/**
 * @function objectId12
 * @description Validate if a string is a ObjectId with 12 characters
 * @param {string} value
 */
const objectId12 = value => (typeof value === 'string' && /^[0-9a-fA-F]{12}$/.test(value));
 ...
 * @param {string} value
 */
const objectId24 = value => (typeof value === 'string' && /^[0-9a-fA-F]{24}$/.test(value));
 ...
 * @param {string} value
 */
const UUID = value => (typeof value === 'string' && UUIDv4Regex.test(value));
